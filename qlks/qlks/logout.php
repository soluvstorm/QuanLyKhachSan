 ...
 <div id="fh5co-page">
   ...
   <div id="fh5co-main">
     ...
     <div class="fh5co-narrow-content">
       <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">ĐĂNG XUẤT</h2>
       <button type="button" class="btn btn-success">
         <?php
         session_start();
         if (session_destroy()) {
           // echo "<p><a href ='indexmain.php'>ĐÃ ĐĂNG XUẤT, BẤM VÀO ĐỂ TRỞ VỀ TRANG CHỦ</a></p>";
           echo "<a href ='indexmain.php'>Đã đăng xuất, bấm vào để trở về trang chủ!</a>";
         }
         ?>
     </button>
     </div>
